    ...
    >
      <div className={`${direction === "rtl" ? 'float-left' : 'float-right'}  h-screen dark:text-gray-200  bg-white dark:bg-[#484B52] w-400` }>
        ...
        <div className='flex-col border-t-1 p-4 ml-4'>
          <p className='font-semibold text-lg'> theem Options </p>
          <div className='mt-4'>
            <input
              type={"radio"}
              id="light"
        ...
        <div className='flex-col border-t-1 p-4 ml-4'>
          <p className='font-semibold text-lg'> Color Options </p>
              ...
              <TooltipComponent key={index} content={item.name} position='topCenter'>
                <div className='relative mt-2 cursor-pointer flex gap-5 items-center'>
                  <button 
                   ...
                   type='button' className='h-10 w-10 cursor-pointer rounded-full'>
